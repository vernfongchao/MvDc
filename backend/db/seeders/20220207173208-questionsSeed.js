...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('Questions', [
      ...
      { title: 'Other than Marvel and DC?', content: 'I never got into other comics but I\'d like to venture out into others', userId: 3, createdAt: new Date(), updatedAt: new Date() },
      { title: 'Who is the strongest character??', content: 'Is it The one above all or The Presence', userId: 1, createdAt: new Date(), updatedAt: new Date() },
      ...
      { title: 'Why are Marvel animation so trash?', content: 'I dont understand why companies keep pumping out these trash animation', userId: 3, createdAt: new Date(), updatedAt: new Date() },
      { title: 'Why did the Justice League films so trash?', content: 'They need to take a page off of Disney', userId: 1, createdAt: new Date(), updatedAt: new Date() },
    ], {});
  },
